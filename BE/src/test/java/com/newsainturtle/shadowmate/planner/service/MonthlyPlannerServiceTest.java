...
class MonthlyPlannerServiceTest {
    ...
    private final User owner = User.builder()
            ...
            .withdrawal(false)
            .build();
    private final User visitor = User.builder()
            .id(2L)
    ...
    class 방명록 {
        ...
        class 방명록추가 {
            ...
            void 실패_자신플래너에방명록추가() {
                ...
                //when
                final PlannerException result = assertThrows(PlannerException.class, () -> monthlyPlannerService.addVisitorBook(visitor, visitor, addVisitorBookRequest));
            ...
            void 성공() {
                ...
                //when
                final VisitorBookResponse addVisitorBookResponse = monthlyPlannerService.addVisitorBook(visitor, owner, addVisitorBookRequest);
        ...
        class 방명록삭제 {
            ...
            void 실패_유효하지않은방명록() {
                ...
                //when
                final PlannerException result = assertThrows(PlannerException.class, () -> monthlyPlannerService.removeVisitorBook(visitor, ownerId, removeVisitorBookRequest));
            ...
            void 실패_삭제권한이없는사용자() {
                ...
                //when
                final PlannerException result = assertThrows(PlannerException.class, () -> monthlyPlannerService.removeVisitorBook(user1, ownerId, removeVisitorBookRequest));
            ...
            void 성공_방명록작성자() {
                ...
                //when
                monthlyPlannerService.removeVisitorBook(visitor, owner.getId(), removeVisitorBookRequest);
            ...
            void 성공_플래너주인() {
                ...
                //when
                monthlyPlannerService.removeVisitorBook(owner, owner.getId(), removeVisitorBookRequest);
        ...
        class 방명록조회 {
            ...
            void 성공_처음() {
                ...
                //when
                final SearchVisitorBookResponse searchVisitorBookResponse = monthlyPlannerService.searchVisitorBook(visitor, owner, 0L);
            ...
            void 성공_연속() {
                ...
                //when
                final SearchVisitorBookResponse searchVisitorBookResponse = monthlyPlannerService.searchVisitorBook(visitor, owner, 100L);
