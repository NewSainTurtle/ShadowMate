...
class WeeklyPlannerServiceTest extends DateCommonService {
    ...
    class 주차별할일등록 {
        ...
        void 실패_올바르지않은날짜_시작요일이월요일이아님() {
            ...
            //when
            final PlannerException result = assertThrows(PlannerException.class, () -> weeklyPlannerService.addWeeklyTodo(user, addWeeklyTodoRequest));
        ...
        void 성공() {
            ...
            //when
            final AddWeeklyTodoResponse addWeeklyTodoResponse = weeklyPlannerService.addWeeklyTodo(user, addWeeklyTodoRequest);
    ...
    class 주차별할일내용수정 {
        ...
        void 실패_올바르지않은날짜_시작요일이월요일이아님() {
            ...
            //when
            final PlannerException result = assertThrows(PlannerException.class, () -> weeklyPlannerService.updateWeeklyTodoContent(user, updateWeeklyTodoContentRequest));
        ...
        void 성공() {
            ...
            //when
            weeklyPlannerService.updateWeeklyTodoContent(user, updateWeeklyTodoContentRequest);
    ...
    class 주차별할일상태수정 {
        ...
        void 실패_올바르지않은날짜_시작요일이월요일이아님() {
            ...
            //when
            final PlannerException result = assertThrows(PlannerException.class, () -> weeklyPlannerService.updateWeeklyTodoStatus(user, updateWeeklyTodoStatusRequest));
        ...
        void 성공() {
            ...
            //when
            weeklyPlannerService.updateWeeklyTodoStatus(user, updateWeeklyTodoStatusRequest);
    ...
    class 주차별할일삭제 {
        ...
        void 실패_올바르지않은날짜_시작요일이월요일이아님() {
            ...
            //when
            final PlannerException result = assertThrows(PlannerException.class, () -> weeklyPlannerService.removeWeeklyTodo(user, removeWeeklyTodoRequest));
        ...
        void 성공() {
            ...
            //when
            weeklyPlannerService.removeWeeklyTodo(user, removeWeeklyTodoRequest);
    ...
    class 주간할일조회 {
        ...
        void 성공_플래너없을때() {
            ...
            //when
            final List<WeeklyPlannerTodoResponse> weeklyTodos = weeklyPlannerService.getWeeklyTodos(user, startDay, endDay, true);
        ...
        void 성공_플래너있을때_권한없음() {
            ...
            //when
            final List<WeeklyPlannerTodoResponse> weeklyTodos = weeklyPlannerService.getWeeklyTodos(user, startDay, endDay, false);
