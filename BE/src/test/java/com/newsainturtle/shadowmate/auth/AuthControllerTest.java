package com.newsainturtle.shadowmate.auth;
...
class AuthControllerTest {
    ...
    class 이메일중복 {
        ...
        void 실패_이메일중복() throws Exception {
            //given
            final SendEmailAuthenticationCodeRequest sendEmailAuthenticationCodeRequest = SendEmailAuthenticationCodeRequest.builder().email(email).build();

            doThrow(new AuthException(AuthErrorResult.DUPLICATED_EMAIL)).when(authService).sendEmailAuthenticationCode(any());
        ...
        void 실패_닉네임중복() throws Exception {
            ...
            final DuplicatedNicknameRequest duplicatedNicknameRequest =
                    DuplicatedNicknameRequest.builder()
                            .nickname(nickname)
                            .build();
            doThrow(new AuthException(AuthErrorResult.DUPLICATED_NICKNAME)).when(authService).duplicatedCheckNickname(any());
    ...
    class 이메일인증 {
        ...
        void 실패_이미인증된이메일() throws Exception {
            ...
            final SendEmailAuthenticationCodeRequest sendEmailAuthenticationCodeRequest = SendEmailAuthenticationCodeRequest.builder()
                    .email(email)
                    .build();
            doThrow(new AuthException(AuthErrorResult.ALREADY_AUTHENTICATED_EMAIL)).when(authService).sendEmailAuthenticationCode(any());
        ...
        void 실패_이메일전송실패() throws Exception {
            ...
            final SendEmailAuthenticationCodeRequest sendEmailAuthenticationCodeRequest = SendEmailAuthenticationCodeRequest.builder()
                    .email(email)
                    .build();
            doThrow(new AuthException(AuthErrorResult.FAIL_SEND_EMAIL)).when(authService).sendEmailAuthenticationCode(any());
    ...
    class 이메일인증코드확인 {
        ...
        void 실패_이메일중복() throws Exception {
            ...
            final CheckEmailAuthenticationCodeRequest checkEmailAuthenticationCodeRequest = CheckEmailAuthenticationCodeRequest.builder()
                    ...
                    .code(code)
                    .build();
            doThrow(new AuthException(AuthErrorResult.DUPLICATED_EMAIL)).when(authService).checkEmailAuthenticationCode(any(CheckEmailAuthenticationCodeRequest.class));
        ...
        void 실패_이메일인증_유효시간지남() throws Exception {
            ...
            final CheckEmailAuthenticationCodeRequest checkEmailAuthenticationCodeRequest = CheckEmailAuthenticationCodeRequest.builder()
                    ...
                    .code(code)
                    .build();
            doThrow(new AuthException(AuthErrorResult.EMAIL_AUTHENTICATION_TIME_OUT)).when(authService).checkEmailAuthenticationCode(any(CheckEmailAuthenticationCodeRequest.class));
        ...
        void 실패_이미인증된이메일사용() throws Exception {
            ...
            final CheckEmailAuthenticationCodeRequest checkEmailAuthenticationCodeRequest = CheckEmailAuthenticationCodeRequest.builder()
                    ...
                    .code(code)
                    .build();
            doThrow(new AuthException(AuthErrorResult.ALREADY_AUTHENTICATED_EMAIL)).when(authService).checkEmailAuthenticationCode(any(CheckEmailAuthenticationCodeRequest.class));
        ...
        void 실패_인증코드틀림() throws Exception {
            ...
            final CheckEmailAuthenticationCodeRequest checkEmailAuthenticationCodeRequest = CheckEmailAuthenticationCodeRequest.builder()
                    ...
                    .code(code)
                    .build();
            doThrow(new AuthException(AuthErrorResult.INVALID_EMAIL_AUTHENTICATION_CODE)).when(authService).checkEmailAuthenticationCode(any(CheckEmailAuthenticationCodeRequest.class));
    ...
    class 회원가입 {
        ...
        void 실패_중복이메일() throws Exception {
            ...
            final JoinRequest joinRequest = JoinRequest.builder()
                    ...
                    .nickname(nickname)
                    .build();
            doThrow(new AuthException(AuthErrorResult.DUPLICATED_EMAIL)).when(authService).join(any());
        ...
        void 실패_임시이메일_타임아웃() throws Exception {
            ...
            final JoinRequest joinRequest = JoinRequest.builder()
                    ...
                    .nickname(nickname)
                    .build();
            doThrow(new AuthException(AuthErrorResult.EMAIL_AUTHENTICATION_TIME_OUT)).when(authService).join(any());
        ...
        void 실패_임시이메일_인증안됨() throws Exception {
            ...
            final JoinRequest joinRequest = JoinRequest.builder()
                    ...
                    .nickname(nickname)
                    .build();
            doThrow(new AuthException(AuthErrorResult.UNAUTHENTICATED_EMAIL)).when(authService).join(any());
    ...
    class 자동로그인 {
        ...
        void 실패_유저없음() throws Exception {
            //given
            doThrow(new AuthException(AuthErrorResult.UNREGISTERED_USER)).when(authService).checkAutoLogin(any(String.class));
